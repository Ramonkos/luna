        ...
        <>
            {targetRestaurant ?
                <>
                    ...
                    <BottomContainer>
                        <CommentContainer>
                            {targetRestaurant.restaurant_reviews.map(review => {
                                return <ReviewWithComment key={`Review ${review.id}`} review={review} restaurantId={targetRestaurant.id}/>
                            })}
                        </CommentContainer>
                        <RightBottomContainer>
                            <PriceReviewEditContainer>
                                ...
                                <ButtonContainer>
                                    <LongOrangeButton onClick={() => {
                                        history.push(`/createreview/${targetRestaurant.id}/`)
                                    }}>WRITE A REVIEW</LongOrangeButton>
                                    {targetRestaurant.logged_in_user_is_restaurant_owner ?
                                        <LongOrangeButton>EDIT DATA</LongOrangeButton> : null}
                                </ButtonContainer>
                            </PriceReviewEditContainer>
                        </RightBottomContainer>
                    </BottomContainer>
